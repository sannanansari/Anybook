...
export class FetchService {
  ...
  getHome() {
    ...
    //     const getData = await this.adb.collection('books').get().pipe(
  ...
  postProfile(data) {
    //async const getData = await await this.adb
    //   .collection('users')
    //   .doc(data.uid)
    //   .update(data);
  ...
  postFavorites(data: book, u_id: string) {
